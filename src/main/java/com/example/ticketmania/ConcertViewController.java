...
import com.example.ticketmania.TicketSelectionController;
...
public class ConcertViewController {
    ...
    public void moveNextPage(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("ticketSelection.fxml"));
            root = loader.load();

            TicketSelectionController ticketSelectionController = loader.getController();
            ticketSelectionController.setConcert(selectedConcert);
